        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Utilisateurs</Typography>
                </FuseAnimate>
            </div>
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/administration/users/new" className="whitespace-no-wrap" variant="contained">
                    <span className="hidden sm:flex">Nouveau utilisateur</span>
